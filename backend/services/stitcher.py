...
async def process_directed_tts_job(segments: list, speaker_mapping: dict, global_speed: float = 1.0, global_volume: float = 1.0, global_pitch: float = 1.0):
    ...
    for i, segment in enumerate(segments):
        ...
        # Emphasis via comma-wrapping: surrounds each emphasis word with commas.
        # F5-TTS reads commas as natural micro-pauses → heavier, deliberate delivery.
        # Safe: no CAPS (acronym spelling), no '!' (shouting). Just rhythm.
        ...
        # Tidy up: collapse double commas, strip leading comma, remove comma before punctuation
